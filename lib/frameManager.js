...
export class FrameManager {
    ...
    adjustFrame() {
        ...
        const includePanelHeight = this.settings.get_boolean("include-panel-height");

        const panelHeight = includePanelHeight
            ? Main.panel
                ? (Main.panel.height ?? Main.panel.actor?.height ?? 0) >> 1
                : 0
            : 0;
